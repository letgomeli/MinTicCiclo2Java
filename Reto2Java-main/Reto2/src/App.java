public class App {
    ...
    vehiculos[0] = new Carro(10000, false, "Mazda", 2015);
    vehiculos[1] = new Carro(8000, false, "Renault", 2010);
    vehiculos[2] = new Moto(5000, false, "Yamaha", 2015);
    vehiculos[3] = new Moto(3000, false, "Suzuki", 2012);
    PrecioTotal solucion2 = new PrecioTotal(vehiculos);
    solucion.mostrarTotales();
    }
 }
